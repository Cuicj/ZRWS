...
import com.zrws.approval.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(
                                ...
                                "/api/v1/climate-warming/**",
                                "/api/v1/desertification/**",
                                "/api/v1/disaster-risk/**",
                                "/api/v1/eco-standard/**",
                                "/api/v1/soil-erosion/**",
                                "/api/v1/gps-track/**",
                                "/api/v1/land-plot/**",
                                "/api/v1/soil-classification/**",
                                "/api/v1/rock-stratum/**",
                                "/api/v1/report/**",
                                "/api/v1/geo-standards/**",
                                "/openapi/**",
                                "/public/**",
                                "/actuator/**",
                                "/swagger-ui/**",
