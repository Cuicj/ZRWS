    ...
    public void init() {
        try {
            ...
            List<SysMenu> menus = Arrays.asList(
                    ...
                    createMenu(0L, "土质分类", "soil-classify", "✦", "土地资源", 2),
                    createMenu(0L, "灾害风险", "disaster-risk", "◬", "土地资源", 3),
                    createMenu(0L, "面积计算", "area-calc", "◭", "土地资源", 4),
                    createMenu(0L, "图纸查看器", "cad-viewer", "▣", "CAD", 1),
                    createMenu(0L, "图纸对比", "cad-compare", "◫", "CAD", 2),
