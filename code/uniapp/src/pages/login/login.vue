<template>
  <view class="login-page">
    ...
    <view class="login-form">
      ...
      <view class="form-extra">
        <label class="checkbox-label">
          <checkbox :checked="form.remember" @change="form.remember = !form.remember" color="#C9A96E" />
          <text>记住密码</text>
        </label>
    ...
    <view class="login-footer">版本 v{{ appVersion }} · 智壤卫士</view>
  </view>
</template>
...
<script setup>
  ...
  const appVersion = typeof __APP_VERSION__ !== 'undefined' ? __APP_VERSION__ : '3.4.0'
...
<style lang="scss" scoped>
  .login-page {
    min-height: 100vh;
    background: linear-gradient(180deg, #C9A96E 0%, #A88B4F 35%, #FEFBF6 100%);
    display: flex;
  ...
  .logo-circle {
    ...
    font-size: 80rpx;
    margin-bottom: 30rpx;
    box-shadow: 0 8rpx 32rpx rgba(93, 78, 55, 0.15);
  }
  .app-title {
    display: block;
    font-size: 48rpx;
