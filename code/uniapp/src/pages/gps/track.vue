...
<style lang="scss" scoped>
  .gps-card {
    ...
    box-shadow: 0 4rpx 16rpx rgba(168, 139, 79, 0.2);
  }
  .gps-head {
    display: flex;
  ...
  .track-dot.active {
    ...
    height: 28rpx;
    opacity: 1;
    box-shadow: 0 0 0 8rpx rgba(124, 179, 66, 0.2);
  }
  .dot-num {
    font-size: 14rpx;
    color: $zrws-text-inverse;
  ...
  .track-table {
    border-radius: 12rpx;
    overflow: hidden;
    border: 1rpx solid $zrws-border-medium;
  }
  .t-row {
    display: grid;
  ...
  .t-row.newest {
    background: rgba($zrws-success, 0.1);
  }
  .t-col {
    text-align: center;
    color: $zrws-text-secondary;
