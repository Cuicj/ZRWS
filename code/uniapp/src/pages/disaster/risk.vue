...
<style lang="scss" scoped>
  .risk-card {
    background: linear-gradient(135deg, $zrws-warning 0%, $zrws-error 100%);
    border-radius: $zrws-radius-lg;
    padding: 32rpx;
    margin-bottom: 24rpx;
    color: $zrws-text-inverse;
    box-shadow: 0 6rpx 20rpx rgba(229, 57, 53, 0.25);
  }
  .rc-head {
    display: flex;
  ...
  .rc-level {
    ...
    font-weight: 700;
    margin-bottom: 12rpx;
    text-shadow: 0 4rpx 12rpx rgba(93, 78, 55, 0.15);
  }
  ...
  .rc-tag.tag-low { background: rgba($zrws-success, 0.35); }
  .rc-tag.tag-warning { background: rgba(255,255,255,0.35); }
  .rc-tag.tag-high { background: rgba($zrws-error, 0.5); }
  ...
  .dc-type { font-size: 30rpx; font-weight: 600; color: $zrws-text-primary; }
  .dc-level {
    padding: 8rpx 22rpx;
    border-radius: 20rpx;
    font-size: 24rpx;
  ...
  .dc-level.level-low { background: rgba($zrws-success, 0.1); color: $zrws-success; }
  .dc-level.level-warning { background: rgba($zrws-warning, 0.1); color: $zrws-warning; }
  .dc-level.level-high { background: rgba($zrws-error, 0.1); color: $zrws-error; }
  .dc-level.level-info { background: $zrws-primary-bg; color: $zrws-primary-dark; }
  ...
  .lg-bar {
    ...
    height: 10rpx;
    border-radius: 5rpx;
    background: linear-gradient(90deg, $zrws-success, $zrws-warning, $zrws-error);
  }
  ...
  .pi-arrow.open { transform: rotate(90deg); color: $zrws-primary; }
  .pi-body {
