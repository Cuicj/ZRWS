...
const steps = [
  ...
  {
    name: 'Step 3/11: Fetch code and checkout v4.0.0',
    command: 'cd /root/workspace/ZRWS && git fetch --tags -f && git checkout v4.0.0',
    timeout: 120000
  },
  {
...
async function main() {
  console.log('='.repeat(60));
  console.log('  ZRWS v4.0.0 Full Deployment');
